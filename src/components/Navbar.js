...
<div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
            <a className="nav-link" style={{display: "table-cell"}} href="https://docs.google.com/document/d/1KMeS7QJI3yYgY8yl-7ELAQMNj5XT5EaXHCyboXHDCEE/edit?usp=sharing" target="_blank">Resume</a>
            </li>
